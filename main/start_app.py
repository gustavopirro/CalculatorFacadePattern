...
from main.constructors.comparison_calculator_constructor import comparison_calculator_process
...
def start_process():
    ...
    while True:
        ...
        elif user_choice == 2: variation_calculator_process()
        elif user_choice == 3: comparison_calculator_process()